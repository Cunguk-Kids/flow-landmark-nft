...
func (_c *CommentCreate) SetMomentID(id int) *CommentCreate {
	_c.mutation.SetMomentID(id)
	return _c
}

// SetMoment sets the "moment" edge to the NFTMoment entity.
func (_c *CommentCreate) SetMoment(v *NFTMoment) *CommentCreate {
...
func (_c *CommentCreate) check() error {
	...
	if len(_c.mutation.MomentIDs()) == 0 {
		return &ValidationError{Name: "moment", err: errors.New(`ent: missing required edge "Comment.moment"`)}
	}
	return nil
}
...
func (_c *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.MomentIDs(); len(nodes) > 0 {
		...
		_node.nft_moment_comments = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}

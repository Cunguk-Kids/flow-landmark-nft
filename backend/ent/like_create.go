...
func (_c *LikeCreate) SetUserID(id int) *LikeCreate {
...
func (_c *LikeCreate) SetMomentID(id int) *LikeCreate {
	_c.mutation.SetMomentID(id)
	return _c
}

// SetMoment sets the "moment" edge to the NFTMoment entity.
func (_c *LikeCreate) SetMoment(v *NFTMoment) *LikeCreate {
...
func (_c *LikeCreate) check() error {
	...
	if len(_c.mutation.MomentIDs()) == 0 {
		return &ValidationError{Name: "moment", err: errors.New(`ent: missing required edge "Like.moment"`)}
	}
	return nil
}
...
func (_c *LikeCreate) createSpec() (*Like, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.MomentIDs(); len(nodes) > 0 {
		...
		_node.nft_moment_likes = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}

// Transaksi: unregister_event.cdc
// Dijalankan oleh: User yang ingin membatalkan registrasi

import "EventPlatform" // Ganti dengan alamat deploy kontrak

// User menyediakan alamat Brand dan ID Event
transaction(brandAddress: Address, eventID: UInt64) {
    ...
    execute {
        // 4. Panggil fungsi 'unregister'
        self.eventRef.unregister(user: self.userAddress)
        log("User berhasil membatalkan registrasi!")
    }
}
...
// Copy paste script di atas ke dalam variabel string ini
const GET_NFT_DETAIL_SCRIPT = `
...
export function useGetNFTDetail({ address, id }: { address: string; id: number }) {
  const { data, isLoading, error, refetch } = useFlowQuery({
    cadence: GET_NFT_DETAIL_SCRIPT,
    args: (arg, t) => [
